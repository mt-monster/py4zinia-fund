...
try:
    from ..strategies.strategy_selector import FundProfile, StrategySelector, StrategyMatchResult
    from ..core.backtest_engine import FundBacktest
    from ..analysis.performance_metrics import PerformanceMetrics, PerformanceCalculator
except ImportError:
    try:
        from fund_search.backtesting.strategies.strategy_selector import FundProfile, StrategySelector, StrategyMatchResult
        from fund_search.backtesting.core.backtest_engine import FundBacktest
        from fund_search.backtesting.analysis.performance_metrics import PerformanceMetrics, PerformanceCalculator
    except ImportError:
        # 创建占位类，以便模块可以独立运行
        FundProfile = None
